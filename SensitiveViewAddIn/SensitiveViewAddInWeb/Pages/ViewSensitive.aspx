<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSensitive.aspx.cs" Inherits="SensitiveViewAddInWeb.Pages.ViewSensitive" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="divSensitive" runat="server">
            ...
            <div>
                ...
                <div style="display: inline-block; padding-right: 10px">
                    <asp:DropDownList ID="ddlFilter" runat="server">
                        ...
                        <asp:ListItem>Perpetual</asp:ListItem>
                        ...
                        <asp:ListItem>ServiceNow Request Number</asp:ListItem>
            ...
            <div></div>
            <div>
                <asp:GridView ID="GridSensitiveView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowPaging="True" PageSize="2" OnPageIndexChanging="GridSensitiveView_PageIndexChanging">
